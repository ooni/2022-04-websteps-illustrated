...
FLAGS: List[Flag] = [
    ...
    Flag(1 << 1, "#dnsTimeout"),
    Flag(1 << 2, "#bogon"),
    Flag(1 << 3, "#dnsNoAnswer"),
    Flag(1 << 4, "#dnsRefused"),
    Flag(1 << 6, "#dnsDiff"),
    Flag(1 << 15, "#dnsOther"),
    Flag(1 << 16, "#tcpTimeout"),
    Flag(1 << 17, "#tcpRefused"),
    Flag(1 << 18, "#quicTimeout"),
    Flag(1 << 19, "#tlsTimeout"),
    Flag(1 << 20, "#tlsEOF"),
    Flag(1 << 21, "#tlsReset"),
    Flag(1 << 22, "#certificate"),
    Flag(1 << 31, "#epntOther"),
    Flag(1 << 33, "#httpTimeout"),
    Flag(1 << 34, "#httpReset"),
    Flag(1 << 35, "#httpEOF"),
    Flag(1 << 36, "#httpDiffStatusCode"),
    Flag(1 << 37, "#httpDiffHeaders"),
    Flag(1 << 38, "#httpDiffTitle"),
    Flag(1 << 39, "#httpDiffBodyLength"),
]
